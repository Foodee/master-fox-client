...
var AppConfigurationDao = exports.AppConfigurationDao = function (_ResourceDao) {
  ...
  function AppConfigurationDao(client) {
    ...
    _this.relationshipDao = new AppConfigurationRelationshipDao(client);
    return _this;
  }
...
var AreaDao = exports.AreaDao = function (_ResourceDao2) {
  ...
  function AreaDao(client) {
    ...
    _this3.relationshipDao = new AreaRelationshipDao(client);
    return _this3;
  }
...
var AreaClosureDao = exports.AreaClosureDao = function (_ResourceDao3) {
  ...
  function AreaClosureDao(client) {
    ...
    _this5.relationshipDao = new AreaClosureRelationshipDao(client);
    return _this5;
  }
...
var ClientDao = exports.ClientDao = function (_ResourceDao4) {
  ...
  function ClientDao(client) {
    ...
    _this7.relationshipDao = new ClientRelationshipDao(client);
    return _this7;
  }
  ...
  function ClientRelationshipDao(client) {
    ...
    _this8.get = {
      ...
      salesSupport: function salesSupport(options) {
        return _this8.toOne('sales-support', options);
      },
    ...
    _this8.index = {
      ...
      teams: function teams(options) {
        return _this8.toMany('teams', options);
      },
...
var ClientDiscountDao = exports.ClientDiscountDao = function (_ResourceDao5) {
  ...
  function ClientDiscountDao(client) {
    ...
    _this9.relationshipDao = new ClientDiscountRelationshipDao(client);
    return _this9;
  }
...
var ClientOrderInvoiceDao = exports.ClientOrderInvoiceDao = function (_ResourceDao6) {
  ...
  function ClientOrderInvoiceDao(client) {
    ...
    _this11.relationshipDao = new ClientOrderInvoiceRelationshipDao(client);
    return _this11;
  }
...
var ClientSignupDao = exports.ClientSignupDao = function (_ResourceDao7) {
  ...
  function ClientSignupDao(client) {
    ...
    _this13.relationshipDao = new ClientSignupRelationshipDao(client);
    return _this13;
  }
...
var CommunicationPreferenceDao = exports.CommunicationPreferenceDao = function (_ResourceDao8) {
  ...
  function CommunicationPreferenceDao(client) {
    ...
    _this15.relationshipDao = new CommunicationPreferenceRelationshipDao(client);
    return _this15;
  }
...
var CompanyDao = exports.CompanyDao = function (_ResourceDao9) {
  ...
  function CompanyDao(client) {
    ...
    _this17.relationshipDao = new CompanyRelationshipDao(client);
    return _this17;
  }
...
var ContactDao = exports.ContactDao = function (_ResourceDao10) {
  ...
  function ContactDao(client) {
    ...
    _this19.relationshipDao = new ContactRelationshipDao(client);
    return _this19;
  }
...
var CourierDao = exports.CourierDao = function (_ResourceDao11) {
  ...
  function CourierDao(client) {
    ...
    _this21.relationshipDao = new CourierRelationshipDao(client);
    return _this21;
  }
...
var DeliveryCaseDao = exports.DeliveryCaseDao = function (_ResourceDao12) {
  ...
  function DeliveryCaseDao(client) {
    ...
    _this23.relationshipDao = new DeliveryCaseRelationshipDao(client);
    return _this23;
  }
...
var DeliveryLocationDao = exports.DeliveryLocationDao = function (_ResourceDao13) {
  ...
  function DeliveryLocationDao(client) {
    ...
    _this25.relationshipDao = new DeliveryLocationRelationshipDao(client);
    return _this25;
  }
...
var DeskCaseDao = exports.DeskCaseDao = function (_ResourceDao14) {
  ...
  function DeskCaseDao(client) {
    ...
    _this27.relationshipDao = new DeskCaseRelationshipDao(client);
    return _this27;
  }
...
var DietaryTagDao = exports.DietaryTagDao = function (_ResourceDao15) {
  ...
  function DietaryTagDao(client) {
    ...
    _this29.relationshipDao = new DietaryTagRelationshipDao(client);
    return _this29;
  }
...
var DiscountCodeDao = exports.DiscountCodeDao = function (_ResourceDao16) {
  ...
  function DiscountCodeDao(client) {
    ...
    _this31.relationshipDao = new DiscountCodeRelationshipDao(client);
    return _this31;
  }
...
var DriverDayDao = exports.DriverDayDao = function (_ResourceDao17) {
  ...
  function DriverDayDao(client) {
    ...
    _this33.relationshipDao = new DriverDayRelationshipDao(client);
    return _this33;
  }
...
var DriverPaymentDao = exports.DriverPaymentDao = function (_ResourceDao18) {
  ...
  function DriverPaymentDao(client) {
    ...
    _this35.relationshipDao = new DriverPaymentRelationshipDao(client);
    return _this35;
  }
...
var DriverPayrollRunDao = exports.DriverPayrollRunDao = function (_ResourceDao19) {
  ...
  function DriverPayrollRunDao(client) {
    ...
    _this37.relationshipDao = new DriverPayrollRunRelationshipDao(client);
    return _this37;
  }
...
var DriverPingDao = exports.DriverPingDao = function (_ResourceDao20) {
  ...
  function DriverPingDao(client) {
    ...
    _this39.relationshipDao = new DriverPingRelationshipDao(client);
    return _this39;
  }
...
var DriverResourceDao = exports.DriverResourceDao = function (_ResourceDao21) {
  ...
  function DriverResourceDao(client) {
    ...
    _this41.relationshipDao = new DriverResourceRelationshipDao(client);
    return _this41;
  }
...
var DriverWeekDao = exports.DriverWeekDao = function (_ResourceDao22) {
  ...
  function DriverWeekDao(client) {
    ...
    _this43.relationshipDao = new DriverWeekRelationshipDao(client);
    return _this43;
  }
...
var EmailMessageDao = exports.EmailMessageDao = function (_ResourceDao23) {
  ...
  function EmailMessageDao(client) {
    ...
    _this45.relationshipDao = new EmailMessageRelationshipDao(client);
    return _this45;
  }
...
var EventDao = exports.EventDao = function (_ResourceDao24) {
  _inherits(EventDao, _ResourceDao24);

  function EventDao(client) {
    _classCallCheck(this, EventDao);

    var _this47 = _possibleConstructorReturn(this, (EventDao.__proto__ || Object.getPrototypeOf(EventDao)).call(this, client, 'events'));

    _this47.relationshipDao = new EventRelationshipDao(client);
    return _this47;
  }
...
var EventRelationshipDao = exports.EventRelationshipDao = function (_RelationshipDao24) {
  _inherits(EventRelationshipDao, _RelationshipDao24);
...
var GiftbitCardDao = exports.GiftbitCardDao = function (_ResourceDao25) {
  _inherits(GiftbitCardDao, _ResourceDao25);

  function GiftbitCardDao(client) {
    _classCallCheck(this, GiftbitCardDao);

    var _this49 = _possibleConstructorReturn(this, (GiftbitCardDao.__proto__ || Object.getPrototypeOf(GiftbitCardDao)).call(this, client, 'giftbit-cards'));

    _this49.relationshipDao = new GiftbitCardRelationshipDao(client);
    return _this49;
  }
...
var GiftbitCardRelationshipDao = exports.GiftbitCardRelationshipDao = function (_RelationshipDao25) {
  _inherits(GiftbitCardRelationshipDao, _RelationshipDao25);
...
var GiftbitErrorDao = exports.GiftbitErrorDao = function (_ResourceDao26) {
  _inherits(GiftbitErrorDao, _ResourceDao26);

  function GiftbitErrorDao(client) {
    _classCallCheck(this, GiftbitErrorDao);

    var _this51 = _possibleConstructorReturn(this, (GiftbitErrorDao.__proto__ || Object.getPrototypeOf(GiftbitErrorDao)).call(this, client, 'giftbit-errors'));

    _this51.relationshipDao = new GiftbitErrorRelationshipDao(client);
    return _this51;
  }
...
var GiftbitErrorRelationshipDao = exports.GiftbitErrorRelationshipDao = function (_RelationshipDao26) {
  _inherits(GiftbitErrorRelationshipDao, _RelationshipDao26);

  function GiftbitErrorRelationshipDao(client) {
    _classCallCheck(this, GiftbitErrorRelationshipDao);

    var _this52 = _possibleConstructorReturn(this, (GiftbitErrorRelationshipDao.__proto__ || Object.getPrototypeOf(GiftbitErrorRelationshipDao)).call(this, client, 'giftbit-errors'));
    ...
    _this52.get = {
      ...
      /** @method order
       ...
       @returns {Promise<Order>} **/
      order: function order(options) {
        return _this52.toOne('order', options);
      }
    };
...
var GiftbitGiftDao = exports.GiftbitGiftDao = function (_ResourceDao27) {
  _inherits(GiftbitGiftDao, _ResourceDao27);

  function GiftbitGiftDao(client) {
    _classCallCheck(this, GiftbitGiftDao);

    var _this53 = _possibleConstructorReturn(this, (GiftbitGiftDao.__proto__ || Object.getPrototypeOf(GiftbitGiftDao)).call(this, client, 'giftbit-gifts'));

    _this53.relationshipDao = new GiftbitGiftRelationshipDao(client);
    return _this53;
  }
...
var GiftbitGiftRelationshipDao = exports.GiftbitGiftRelationshipDao = function (_RelationshipDao27) {
  _inherits(GiftbitGiftRelationshipDao, _RelationshipDao27);
...
var GroupOrderMemberDao = exports.GroupOrderMemberDao = function (_ResourceDao28) {
  _inherits(GroupOrderMemberDao, _ResourceDao28);

  function GroupOrderMemberDao(client) {
    _classCallCheck(this, GroupOrderMemberDao);

    var _this55 = _possibleConstructorReturn(this, (GroupOrderMemberDao.__proto__ || Object.getPrototypeOf(GroupOrderMemberDao)).call(this, client, 'group-order-members'));

    _this55.relationshipDao = new GroupOrderMemberRelationshipDao(client);
    return _this55;
  }
...
var GroupOrderMemberRelationshipDao = exports.GroupOrderMemberRelationshipDao = function (_RelationshipDao28) {
  _inherits(GroupOrderMemberRelationshipDao, _RelationshipDao28);

  function GroupOrderMemberRelationshipDao(client) {
    _classCallCheck(this, GroupOrderMemberRelationshipDao);

    var _this56 = _possibleConstructorReturn(this, (GroupOrderMemberRelationshipDao.__proto__ || Object.getPrototypeOf(GroupOrderMemberRelationshipDao)).call(this, client, 'group-order-members'));
    ...
    _this56.get = {
      ...
      /** @method user
       ...
       @returns {Promise<User>} **/
      user: function user(options) {
        return _this56.toOne('user', options);
      },
      ...
      /** @method order
       ...
       @returns {Promise<Order>} **/
      order: function order(options) {
        return _this56.toOne('order', options);
      }
    };
    ...
    _this56.index = {
      ...
      orderItems: function orderItems(options) {
        return _this56.toMany('order-items', options);
      }
    };
    return _this56;
  }
...
var InvoiceDao = exports.InvoiceDao = function (_ResourceDao29) {
  ...
  function InvoiceDao(client) {
    ...
    var _this57 = _possibleConstructorReturn(this, (InvoiceDao.__proto__ || Object.getPrototypeOf(InvoiceDao)).call(this, client, 'invoices'));

    _this57.relationshipDao = new InvoiceRelationshipDao(client);
    return _this57;
  }
...
var InvoiceRelationshipDao = exports.InvoiceRelationshipDao = function (_RelationshipDao29) {
  _inherits(InvoiceRelationshipDao, _RelationshipDao29);
...
var InvoicingTaxRateDao = exports.InvoicingTaxRateDao = function (_ResourceDao30) {
  _inherits(InvoicingTaxRateDao, _ResourceDao30);

  function InvoicingTaxRateDao(client) {
    _classCallCheck(this, InvoicingTaxRateDao);

    var _this59 = _possibleConstructorReturn(this, (InvoicingTaxRateDao.__proto__ || Object.getPrototypeOf(InvoicingTaxRateDao)).call(this, client, 'invoicing-tax-rates'));

    _this59.relationshipDao = new InvoicingTaxRateRelationshipDao(client);
    return _this59;
  }
...
var InvoicingTaxRateRelationshipDao = exports.InvoicingTaxRateRelationshipDao = function (_RelationshipDao30) {
  _inherits(InvoicingTaxRateRelationshipDao, _RelationshipDao30);

  function InvoicingTaxRateRelationshipDao(client) {
    _classCallCheck(this, InvoicingTaxRateRelationshipDao);

    var _this60 = _possibleConstructorReturn(this, (InvoicingTaxRateRelationshipDao.__proto__ || Object.getPrototypeOf(InvoicingTaxRateRelationshipDao)).call(this, client, 'invoicing-tax-rates'));
...
var LocationDao = exports.LocationDao = function (_ResourceDao31) {
  _inherits(LocationDao, _ResourceDao31);

  function LocationDao(client) {
    _classCallCheck(this, LocationDao);

    var _this61 = _possibleConstructorReturn(this, (LocationDao.__proto__ || Object.getPrototypeOf(LocationDao)).call(this, client, 'locations'));

    _this61.relationshipDao = new LocationRelationshipDao(client);
    return _this61;
  }
...
var LocationRelationshipDao = exports.LocationRelationshipDao = function (_RelationshipDao31) {
  _inherits(LocationRelationshipDao, _RelationshipDao31);

  function LocationRelationshipDao(client) {
    _classCallCheck(this, LocationRelationshipDao);

    var _this62 = _possibleConstructorReturn(this, (LocationRelationshipDao.__proto__ || Object.getPrototypeOf(LocationRelationshipDao)).call(this, client, 'locations'));
    ...
    _this62.get = {
      ...
      /** @method area
       ...
       @returns {Promise<Area>} **/
      area: function area(options) {
        return _this62.toOne('area', options);
      }
    };
...
var MealPlanDao = exports.MealPlanDao = function (_ResourceDao32) {
  _inherits(MealPlanDao, _ResourceDao32);

  function MealPlanDao(client) {
    _classCallCheck(this, MealPlanDao);

    var _this63 = _possibleConstructorReturn(this, (MealPlanDao.__proto__ || Object.getPrototypeOf(MealPlanDao)).call(this, client, 'meal-plans'));

    _this63.relationshipDao = new MealPlanRelationshipDao(client);
    return _this63;
  }
...
var MealPlanRelationshipDao = exports.MealPlanRelationshipDao = function (_RelationshipDao32) {
  _inherits(MealPlanRelationshipDao, _RelationshipDao32);

  function MealPlanRelationshipDao(client) {
    _classCallCheck(this, MealPlanRelationshipDao);

    var _this64 = _possibleConstructorReturn(this, (MealPlanRelationshipDao.__proto__ || Object.getPrototypeOf(MealPlanRelationshipDao)).call(this, client, 'meal-plans'));
    ...
    _this64.get = {
      ...
      mealPlanUser: function mealPlanUser(options) {
        return _this64.toOne('meal-plan-user', options);
      },
      ...
      /** @method client
       ...
       @returns {Promise<Client>} **/
      client: function client(options) {
        return _this64.toOne('client', options);
      }
    };
...
var MenuDao = exports.MenuDao = function (_ResourceDao33) {
  ...
  function MenuDao(client) {
    ...
    var _this65 = _possibleConstructorReturn(this, (MenuDao.__proto__ || Object.getPrototypeOf(MenuDao)).call(this, client, 'menus'));

    _this65.relationshipDao = new MenuRelationshipDao(client);
    return _this65;
  }
...
var MenuRelationshipDao = exports.MenuRelationshipDao = function (_RelationshipDao33) {
  _inherits(MenuRelationshipDao, _RelationshipDao33);

  function MenuRelationshipDao(client) {
    _classCallCheck(this, MenuRelationshipDao);

    var _this66 = _possibleConstructorReturn(this, (MenuRelationshipDao.__proto__ || Object.getPrototypeOf(MenuRelationshipDao)).call(this, client, 'menus'));
    ...
    _this66.index = {
      ...
      menuGroups: function menuGroups(options) {
        return _this66.toMany('menu-groups', options);
      },
      ...
      /** @method orders
       ...
       @returns {Promise<IndexResult<Order>>} **/
      orders: function orders(options) {
        return _this66.toMany('orders', options);
      }
    };
    return _this66;
  }
...
var MenuGroupDao = exports.MenuGroupDao = function (_ResourceDao34) {
  _inherits(MenuGroupDao, _ResourceDao34);

  function MenuGroupDao(client) {
    _classCallCheck(this, MenuGroupDao);

    var _this67 = _possibleConstructorReturn(this, (MenuGroupDao.__proto__ || Object.getPrototypeOf(MenuGroupDao)).call(this, client, 'menu-groups'));

    _this67.relationshipDao = new MenuGroupRelationshipDao(client);
    return _this67;
  }
...
var MenuGroupRelationshipDao = exports.MenuGroupRelationshipDao = function (_RelationshipDao34) {
  _inherits(MenuGroupRelationshipDao, _RelationshipDao34);

  function MenuGroupRelationshipDao(client) {
    _classCallCheck(this, MenuGroupRelationshipDao);

    var _this68 = _possibleConstructorReturn(this, (MenuGroupRelationshipDao.__proto__ || Object.getPrototypeOf(MenuGroupRelationshipDao)).call(this, client, 'menu-groups'));
    ...
    _this68.index = {
      ...
      /** @method menuItems
       ...
       @returns {Promise<IndexResult<MenuItem>>} **/
      menuItems: function menuItems(options) {
        return _this68.toMany('menu-items', options);
      }
    };
    return _this68;
  }
...
var MenuItemDao = exports.MenuItemDao = function (_ResourceDao35) {
  _inherits(MenuItemDao, _ResourceDao35);

  function MenuItemDao(client) {
    _classCallCheck(this, MenuItemDao);

    var _this69 = _possibleConstructorReturn(this, (MenuItemDao.__proto__ || Object.getPrototypeOf(MenuItemDao)).call(this, client, 'menu-items'));

    _this69.relationshipDao = new MenuItemRelationshipDao(client);
    return _this69;
  }
...
var MenuItemRelationshipDao = exports.MenuItemRelationshipDao = function (_RelationshipDao35) {
  _inherits(MenuItemRelationshipDao, _RelationshipDao35);

  function MenuItemRelationshipDao(client) {
    _classCallCheck(this, MenuItemRelationshipDao);

    var _this70 = _possibleConstructorReturn(this, (MenuItemRelationshipDao.__proto__ || Object.getPrototypeOf(MenuItemRelationshipDao)).call(this, client, 'menu-items'));
    ...
    _this70.get = {
      ...
      /** @method taxRate
       ...
       @returns {Promise<InvoicingTaxRate>} **/
      taxRate: function taxRate(options) {
        return _this70.toOne('tax-rate', options);
      },
      ...
      menuGroup: function menuGroup(options) {
        return _this70.toOne('menu-group', options);
      }
    };
    ...
    _this70.index = {
      ...
      /** @method dietaryTags
       ...
       @returns {Promise<IndexResult<DietaryTag>>} **/
      dietaryTags: function dietaryTags(options) {
        return _this70.toMany('dietary-tags', options);
      },
      ...
      menuOptionGroups: function menuOptionGroups(options) {
        return _this70.toMany('menu-option-groups', options);
      }
    };
    return _this70;
  }
...
var MenuOptionGroupDao = exports.MenuOptionGroupDao = function (_ResourceDao36) {
  _inherits(MenuOptionGroupDao, _ResourceDao36);

  function MenuOptionGroupDao(client) {
    _classCallCheck(this, MenuOptionGroupDao);

    var _this71 = _possibleConstructorReturn(this, (MenuOptionGroupDao.__proto__ || Object.getPrototypeOf(MenuOptionGroupDao)).call(this, client, 'menu-option-groups'));

    _this71.relationshipDao = new MenuOptionGroupRelationshipDao(client);
    return _this71;
  }
...
var MenuOptionGroupRelationshipDao = exports.MenuOptionGroupRelationshipDao = function (_RelationshipDao36) {
  _inherits(MenuOptionGroupRelationshipDao, _RelationshipDao36);

  function MenuOptionGroupRelationshipDao(client) {
    _classCallCheck(this, MenuOptionGroupRelationshipDao);

    var _this72 = _possibleConstructorReturn(this, (MenuOptionGroupRelationshipDao.__proto__ || Object.getPrototypeOf(MenuOptionGroupRelationshipDao)).call(this, client, 'menu-option-groups'));
    ...
    _this72.get = {
      ...
      menuItem: function menuItem(options) {
        return _this72.toOne('menu-item', options);
      }
    };
    ...
    _this72.index = {
      ...
      /** @method menuOptionItems
       ...
       @returns {Promise<IndexResult<MenuOptionItem>>} **/
      menuOptionItems: function menuOptionItems(options) {
        return _this72.toMany('menu-option-items', options);
      }
    };
    return _this72;
  }
...
var MenuOptionItemDao = exports.MenuOptionItemDao = function (_ResourceDao37) {
  _inherits(MenuOptionItemDao, _ResourceDao37);

  function MenuOptionItemDao(client) {
    _classCallCheck(this, MenuOptionItemDao);

    var _this73 = _possibleConstructorReturn(this, (MenuOptionItemDao.__proto__ || Object.getPrototypeOf(MenuOptionItemDao)).call(this, client, 'menu-option-items'));

    _this73.relationshipDao = new MenuOptionItemRelationshipDao(client);
    return _this73;
  }
...
var MenuOptionItemRelationshipDao = exports.MenuOptionItemRelationshipDao = function (_RelationshipDao37) {
  _inherits(MenuOptionItemRelationshipDao, _RelationshipDao37);

  function MenuOptionItemRelationshipDao(client) {
    _classCallCheck(this, MenuOptionItemRelationshipDao);

    var _this74 = _possibleConstructorReturn(this, (MenuOptionItemRelationshipDao.__proto__ || Object.getPrototypeOf(MenuOptionItemRelationshipDao)).call(this, client, 'menu-option-items'));
    ...
    _this74.get = {
      ...
      menuOptionGroup: function menuOptionGroup(options) {
        return _this74.toOne('menu-option-group', options);
      }
    };
    ...
    _this74.index = {
      ...
      /** @method dietaryTags
       ...
       @returns {Promise<IndexResult<DietaryTag>>} **/
      dietaryTags: function dietaryTags(options) {
        return _this74.toMany('dietary-tags', options);
      },
...
var OrderDao = exports.OrderDao = function (_ResourceDao38) {
  _inherits(OrderDao, _ResourceDao38);

  function OrderDao(client) {
    _classCallCheck(this, OrderDao);

    var _this75 = _possibleConstructorReturn(this, (OrderDao.__proto__ || Object.getPrototypeOf(OrderDao)).call(this, client, 'orders'));

    _this75.relationshipDao = new OrderRelationshipDao(client);
    return _this75;
  }
...
var OrderRelationshipDao = exports.OrderRelationshipDao = function (_RelationshipDao38) {
  _inherits(OrderRelationshipDao, _RelationshipDao38);

  function OrderRelationshipDao(client) {
    _classCallCheck(this, OrderRelationshipDao);

    var _this76 = _possibleConstructorReturn(this, (OrderRelationshipDao.__proto__ || Object.getPrototypeOf(OrderRelationshipDao)).call(this, client, 'orders'));
    ...
    _this76.get = {
      ...
      /** @method area
       ...
       @returns {Promise<Area>} **/
      area: function area(options) {
        return _this76.toOne('area', options);
      },
      ...
      /** @method owner
       ...
       @returns {Promise<User>} **/
      owner: function owner(options) {
        return _this76.toOne('owner', options);
      },
      ...
      creator: function creator(options) {
        return _this76.toOne('creator', options);
      },
      ...
      paymentCard: function paymentCard(options) {
        return _this76.toOne('payment-card', options);
      },
      ...
      /** @method contact
       ...
       @returns {Promise<Contact>} **/
      contact: function contact(options) {
        return _this76.toOne('contact', options);
      },
      ...
      /** @method client
       ...
       @returns {Promise<Client>} **/
      client: function client(options) {
        return _this76.toOne('client', options);
      },
      ...
      courier: function courier(options) {
        return _this76.toOne('courier', options);
      },
      ...
      promoCode: function promoCode(options) {
        return _this76.toOne('promo-code', options);
      },
      ...
      /** @method driver
       ...
       @returns {Promise<User>} **/
      driver: function driver(options) {
        return _this76.toOne('driver', options);
      },
      ...
      /** @method salesSupport
       ...
       @returns {Promise<User>} **/
      salesSupport: function salesSupport(options) {
        return _this76.toOne('sales-support', options);
      },
      ...
      restaurantLocation: function restaurantLocation(options) {
        return _this76.toOne('restaurant-location', options);
      },
      ...
      clientLocation: function clientLocation(options) {
        return _this76.toOne('client-location', options);
      },
      ...
      clientDiscount: function clientDiscount(options) {
        return _this76.toOne('client-discount', options);
      },
      ...
      restaurantDiscount: function restaurantDiscount(options) {
        return _this76.toOne('restaurant-discount', options);
      },
      ...
      /** @method menu
       ...
       @returns {Promise<Menu>} **/
      menu: function menu(options) {
        return _this76.toOne('menu', options);
      },
      ...
      customLocation: function customLocation(options) {
        return _this76.toOne('custom-location', options);
      },
      ...
      giftbitError: function giftbitError(options) {
        return _this76.toOne('giftbit-error', options);
      },
      ...
      clientOrderInvoice: function clientOrderInvoice(options) {
        return _this76.toOne('client-order-invoice', options);
      },
      ...
      restaurantOrderInvoice: function restaurantOrderInvoice(options) {
        return _this76.toOne('restaurant-order-invoice', options);
      }
    };
    ...
    _this76.index = {
      ...
      emailMessages: function emailMessages(options) {
        return _this76.toMany('email-messages', options);
      },
      ...
      deliveryCases: function deliveryCases(options) {
        return _this76.toMany('delivery-cases', options);
      },
      ...
      deskCases: function deskCases(options) {
        return _this76.toMany('desk-cases', options);
      },
      ...
      /** @method versions
       ...
       @returns {Promise<IndexResult<Version>>} **/
      versions: function versions(options) {
        return _this76.toMany('versions', options);
      },
      ...
      pollableRestaurants: function pollableRestaurants(options) {
        return _this76.toMany('pollable-restaurants', options);
      },
      ...
      restaurantVotes: function restaurantVotes(options) {
        return _this76.toMany('restaurant-votes', options);
      },
      ...
      groupOrderMembers: function groupOrderMembers(options) {
        return _this76.toMany('group-order-members', options);
      },
      ...
      /** @method orderItems
       ...
       @returns {Promise<IndexResult<OrderItem>>} **/
      orderItems: function orderItems(options) {
        return _this76.toMany('order-items', options);
      }
    };
    return _this76;
  }
...
var OrderItemDao = exports.OrderItemDao = function (_ResourceDao39) {
  _inherits(OrderItemDao, _ResourceDao39);

  function OrderItemDao(client) {
    _classCallCheck(this, OrderItemDao);

    var _this77 = _possibleConstructorReturn(this, (OrderItemDao.__proto__ || Object.getPrototypeOf(OrderItemDao)).call(this, client, 'order-items'));

    _this77.relationshipDao = new OrderItemRelationshipDao(client);
    return _this77;
  }
...
var OrderItemRelationshipDao = exports.OrderItemRelationshipDao = function (_RelationshipDao39) {
  _inherits(OrderItemRelationshipDao, _RelationshipDao39);

  function OrderItemRelationshipDao(client) {
    _classCallCheck(this, OrderItemRelationshipDao);

    var _this78 = _possibleConstructorReturn(this, (OrderItemRelationshipDao.__proto__ || Object.getPrototypeOf(OrderItemRelationshipDao)).call(this, client, 'order-items'));
    ...
    _this78.get = {
      ...
      /** @method order
       ...
       @returns {Promise<Order>} **/
      order: function order(options) {
        return _this78.toOne('order', options);
      },
      ...
      /** @method menuItem
       ...
       @returns {Promise<MenuItem>} **/
      menuItem: function menuItem(options) {
        return _this78.toOne('menu-item', options);
      },
      ...
      groupOrderMember: function groupOrderMember(options) {
        return _this78.toOne('group-order-member', options);
      }
    };
    ...
    _this78.index = {
      ...
      /** @method menuOptionItems
       ...
       @returns {Promise<IndexResult<MenuOptionItem>>} **/
      menuOptionItems: function menuOptionItems(options) {
        return _this78.toMany('menu-option-items', options);
      }
    };
    return _this78;
  }
...
var PaymentAccountDao = exports.PaymentAccountDao = function (_ResourceDao40) {
  _inherits(PaymentAccountDao, _ResourceDao40);

  function PaymentAccountDao(client) {
    _classCallCheck(this, PaymentAccountDao);

    var _this79 = _possibleConstructorReturn(this, (PaymentAccountDao.__proto__ || Object.getPrototypeOf(PaymentAccountDao)).call(this, client, 'payment-accounts'));

    _this79.relationshipDao = new PaymentAccountRelationshipDao(client);
    return _this79;
  }
...
var PaymentAccountRelationshipDao = exports.PaymentAccountRelationshipDao = function (_RelationshipDao40) {
  _inherits(PaymentAccountRelationshipDao, _RelationshipDao40);
...
var PaymentCardDao = exports.PaymentCardDao = function (_ResourceDao41) {
  _inherits(PaymentCardDao, _ResourceDao41);

  function PaymentCardDao(client) {
    _classCallCheck(this, PaymentCardDao);

    var _this81 = _possibleConstructorReturn(this, (PaymentCardDao.__proto__ || Object.getPrototypeOf(PaymentCardDao)).call(this, client, 'payment-cards'));

    _this81.relationshipDao = new PaymentCardRelationshipDao(client);
    return _this81;
  }
...
var PaymentCardRelationshipDao = exports.PaymentCardRelationshipDao = function (_RelationshipDao41) {
  _inherits(PaymentCardRelationshipDao, _RelationshipDao41);

  function PaymentCardRelationshipDao(client) {
    _classCallCheck(this, PaymentCardRelationshipDao);

    var _this82 = _possibleConstructorReturn(this, (PaymentCardRelationshipDao.__proto__ || Object.getPrototypeOf(PaymentCardRelationshipDao)).call(this, client, 'payment-cards'));
    ...
    _this82.get = {
      ...
      /** @method client
       ...
       @returns {Promise<Client>} **/
      client: function client(options) {
        return _this82.toOne('client', options);
      },
      ...
      /** @method user
       ...
       @returns {Promise<User>} **/
      user: function user(options) {
        return _this82.toOne('user', options);
      }
    };
...
var PayrollRunDao = exports.PayrollRunDao = function (_ResourceDao42) {
  _inherits(PayrollRunDao, _ResourceDao42);

  function PayrollRunDao(client) {
    _classCallCheck(this, PayrollRunDao);

    var _this83 = _possibleConstructorReturn(this, (PayrollRunDao.__proto__ || Object.getPrototypeOf(PayrollRunDao)).call(this, client, 'payroll-runs'));

    _this83.relationshipDao = new PayrollRunRelationshipDao(client);
    return _this83;
  }
...
var PayrollRunRelationshipDao = exports.PayrollRunRelationshipDao = function (_RelationshipDao42) {
  _inherits(PayrollRunRelationshipDao, _RelationshipDao42);

  function PayrollRunRelationshipDao(client) {
    _classCallCheck(this, PayrollRunRelationshipDao);

    var _this84 = _possibleConstructorReturn(this, (PayrollRunRelationshipDao.__proto__ || Object.getPrototypeOf(PayrollRunRelationshipDao)).call(this, client, 'payroll-runs'));
    ...
    _this84.index = {
      ...
      driverPayrollRun: function driverPayrollRun(options) {
        return _this84.toMany('driver-payroll-runs', options);
      }
    };
    return _this84;
  }
...
var PickupLocationDao = exports.PickupLocationDao = function (_ResourceDao43) {
  _inherits(PickupLocationDao, _ResourceDao43);

  function PickupLocationDao(client) {
    _classCallCheck(this, PickupLocationDao);

    var _this85 = _possibleConstructorReturn(this, (PickupLocationDao.__proto__ || Object.getPrototypeOf(PickupLocationDao)).call(this, client, 'pickup-locations'));

    _this85.relationshipDao = new PickupLocationRelationshipDao(client);
    return _this85;
  }
...
var PickupLocationRelationshipDao = exports.PickupLocationRelationshipDao = function (_RelationshipDao43) {
  _inherits(PickupLocationRelationshipDao, _RelationshipDao43);

  function PickupLocationRelationshipDao(client) {
    _classCallCheck(this, PickupLocationRelationshipDao);

    var _this86 = _possibleConstructorReturn(this, (PickupLocationRelationshipDao.__proto__ || Object.getPrototypeOf(PickupLocationRelationshipDao)).call(this, client, 'pickup-locations'));
    ...
    _this86.get = {
      ...
      /** @method restaurant
       ...
       @returns {Promise<Restaurant>} **/
      restaurant: function restaurant(options) {
        return _this86.toOne('restaurant', options);
      },
      ...
      /** @method location
       ...
       @returns {Promise<Location>} **/
      location: function location(options) {
        return _this86.toOne('location', options);
      }
    };
...
var PromoCodeDao = exports.PromoCodeDao = function (_ResourceDao44) {
  _inherits(PromoCodeDao, _ResourceDao44);

  function PromoCodeDao(client) {
    _classCallCheck(this, PromoCodeDao);

    var _this87 = _possibleConstructorReturn(this, (PromoCodeDao.__proto__ || Object.getPrototypeOf(PromoCodeDao)).call(this, client, 'promo-codes'));

    _this87.relationshipDao = new PromoCodeRelationshipDao(client);
    return _this87;
  }
...
var PromoCodeRelationshipDao = exports.PromoCodeRelationshipDao = function (_RelationshipDao44) {
  _inherits(PromoCodeRelationshipDao, _RelationshipDao44);

  function PromoCodeRelationshipDao(client) {
    _classCallCheck(this, PromoCodeRelationshipDao);

    var _this88 = _possibleConstructorReturn(this, (PromoCodeRelationshipDao.__proto__ || Object.getPrototypeOf(PromoCodeRelationshipDao)).call(this, client, 'promo-codes'));
    ...
    _this88.get = {
      ...
      /** @method restaurant
       ...
       @returns {Promise<Restaurant>} **/
      restaurant: function restaurant(options) {
        return _this88.toOne('restaurant', options);
      }
    };
...
var QualifyingQuestionDao = exports.QualifyingQuestionDao = function (_ResourceDao45) {
  _inherits(QualifyingQuestionDao, _ResourceDao45);

  function QualifyingQuestionDao(client) {
    _classCallCheck(this, QualifyingQuestionDao);

    var _this89 = _possibleConstructorReturn(this, (QualifyingQuestionDao.__proto__ || Object.getPrototypeOf(QualifyingQuestionDao)).call(this, client, 'qualifying-questions'));

    _this89.relationshipDao = new QualifyingQuestionRelationshipDao(client);
    return _this89;
  }
...
var QualifyingQuestionRelationshipDao = exports.QualifyingQuestionRelationshipDao = function (_RelationshipDao45) {
  _inherits(QualifyingQuestionRelationshipDao, _RelationshipDao45);
...
var RestaurantDao = exports.RestaurantDao = function (_ResourceDao46) {
  _inherits(RestaurantDao, _ResourceDao46);

  function RestaurantDao(client) {
    _classCallCheck(this, RestaurantDao);

    var _this91 = _possibleConstructorReturn(this, (RestaurantDao.__proto__ || Object.getPrototypeOf(RestaurantDao)).call(this, client, 'restaurants'));

    _this91.relationshipDao = new RestaurantRelationshipDao(client);
    return _this91;
  }
...
var RestaurantRelationshipDao = exports.RestaurantRelationshipDao = function (_RelationshipDao46) {
  _inherits(RestaurantRelationshipDao, _RelationshipDao46);

  function RestaurantRelationshipDao(client) {
    _classCallCheck(this, RestaurantRelationshipDao);

    var _this92 = _possibleConstructorReturn(this, (RestaurantRelationshipDao.__proto__ || Object.getPrototypeOf(RestaurantRelationshipDao)).call(this, client, 'restaurants'));
    ...
    _this92.get = {
      ...
      /** @method billingLocation
       ...
       @returns {Promise<Location>} **/
      billingLocation: function billingLocation(options) {
        return _this92.toOne('billing-location', options);
      },
      ...
      /** @method billingContact
       ...
       @returns {Promise<Contact>} **/
      billingContact: function billingContact(options) {
        return _this92.toOne('billing-contact', options);
      },
      ...
      /** @method owner
       ...
       @returns {Promise<User>} **/
      owner: function owner(options) {
        return _this92.toOne('owner', options);
      }
    };
    ...
    _this92.index = {
      ...
      restaurantCapacityTranches: function restaurantCapacityTranches(options) {
        return _this92.toMany('restaurant-capacity-tranches', options);
      },
      ...
      serviceTimes: function serviceTimes(options) {
        return _this92.toMany('service-times', options);
      },
      ...
      pickupLocations: function pickupLocations(options) {
        return _this92.toMany('pickup-locations', options);
      },
      ...
      /** @method admins
       ...
       @returns {Promise<IndexResult<User>>} **/
      admins: function admins(options) {
        return _this92.toMany('admins', options);
      },
      ...
      /** @method adminContacts
       ...
       @returns {Promise<IndexResult<Contact>>} **/
      adminContacts: function adminContacts(options) {
        return _this92.toMany('admin-contacts', options);
      },
      ...
      /** @method dietaryTags
       ...
       @returns {Promise<IndexResult<DietaryTag>>} **/
      dietaryTags: function dietaryTags(options) {
        return _this92.toMany('dietary-tags', options);
      },
      ...
      tags: function tags(options) {
        return _this92.toMany('tags', options);
      },
      ...
      /** @method areas
       ...
       @returns {Promise<IndexResult<Area>>} **/
      areas: function areas(options) {
        return _this92.toMany('areas', options);
      },
      ...
      menus: function menus(options) {
        return _this92.toMany('menus', options);
      },
      ...
      /** @method restaurantVotes
       ...
       @returns {Promise<IndexResult<RestaurantVote>>} **/
      restaurantVotes: function restaurantVotes(options) {
        return _this92.toMany('restaurant-votes', options);
      },
      ...
      closures: function closures(options) {
        return _this92.toMany('closures', options);
      },
      ...
      /** @method versions
       ...
       @returns {Promise<IndexResult<Version>>} **/
      versions: function versions(options) {
        return _this92.toMany('versions', options);
      },
      ...
      /** @method promoCodes
       ...
       @returns {Promise<IndexResult<PromoCode>>} **/
      promoCodes: function promoCodes(options) {
        return _this92.toMany('promo-codes', options);
      }
    };
    return _this92;
  }
...
var RestaurantCapacityTrancheDao = exports.RestaurantCapacityTrancheDao = function (_ResourceDao47) {
  _inherits(RestaurantCapacityTrancheDao, _ResourceDao47);

  function RestaurantCapacityTrancheDao(client) {
    _classCallCheck(this, RestaurantCapacityTrancheDao);

    var _this93 = _possibleConstructorReturn(this, (RestaurantCapacityTrancheDao.__proto__ || Object.getPrototypeOf(RestaurantCapacityTrancheDao)).call(this, client, 'restaurant-capacity-tranches'));

    _this93.relationshipDao = new RestaurantCapacityTrancheRelationshipDao(client);
    return _this93;
  }
...
var RestaurantCapacityTrancheRelationshipDao = exports.RestaurantCapacityTrancheRelationshipDao = function (_RelationshipDao47) {
  _inherits(RestaurantCapacityTrancheRelationshipDao, _RelationshipDao47);

  function RestaurantCapacityTrancheRelationshipDao(client) {
    _classCallCheck(this, RestaurantCapacityTrancheRelationshipDao);

    var _this94 = _possibleConstructorReturn(this, (RestaurantCapacityTrancheRelationshipDao.__proto__ || Object.getPrototypeOf(RestaurantCapacityTrancheRelationshipDao)).call(this, client, 'restaurant-capacity-tranches'));
...
var RestaurantClosureDao = exports.RestaurantClosureDao = function (_ResourceDao48) {
  _inherits(RestaurantClosureDao, _ResourceDao48);

  function RestaurantClosureDao(client) {
    _classCallCheck(this, RestaurantClosureDao);

    var _this95 = _possibleConstructorReturn(this, (RestaurantClosureDao.__proto__ || Object.getPrototypeOf(RestaurantClosureDao)).call(this, client, 'restaurant-closures'));

    _this95.relationshipDao = new RestaurantClosureRelationshipDao(client);
    return _this95;
  }
...
var RestaurantClosureRelationshipDao = exports.RestaurantClosureRelationshipDao = function (_RelationshipDao48) {
  _inherits(RestaurantClosureRelationshipDao, _RelationshipDao48);

  function RestaurantClosureRelationshipDao(client) {
    _classCallCheck(this, RestaurantClosureRelationshipDao);

    var _this96 = _possibleConstructorReturn(this, (RestaurantClosureRelationshipDao.__proto__ || Object.getPrototypeOf(RestaurantClosureRelationshipDao)).call(this, client, 'restaurant-closures'));
    ...
    _this96.get = {
      ...
      /** @method restaurant
       ...
       @returns {Promise<Restaurant>} **/
      restaurant: function restaurant(options) {
        return _this96.toOne('restaurant', options);
      }
    };
...
var RestaurantDiscountDao = exports.RestaurantDiscountDao = function (_ResourceDao49) {
  _inherits(RestaurantDiscountDao, _ResourceDao49);

  function RestaurantDiscountDao(client) {
    _classCallCheck(this, RestaurantDiscountDao);

    var _this97 = _possibleConstructorReturn(this, (RestaurantDiscountDao.__proto__ || Object.getPrototypeOf(RestaurantDiscountDao)).call(this, client, 'restaurant-discounts'));

    _this97.relationshipDao = new RestaurantDiscountRelationshipDao(client);
    return _this97;
  }
...
var RestaurantDiscountRelationshipDao = exports.RestaurantDiscountRelationshipDao = function (_RelationshipDao49) {
  _inherits(RestaurantDiscountRelationshipDao, _RelationshipDao49);

  function RestaurantDiscountRelationshipDao(client) {
    _classCallCheck(this, RestaurantDiscountRelationshipDao);

    var _this98 = _possibleConstructorReturn(this, (RestaurantDiscountRelationshipDao.__proto__ || Object.getPrototypeOf(RestaurantDiscountRelationshipDao)).call(this, client, 'restaurant-discounts'));
    ...
    _this98.get = {
      ...
      /** @method order
       ...
       @returns {Promise<Order>} **/
      order: function order(options) {
        return _this98.toOne('order', options);
      }
    };
...
var RestaurantOrderInvoiceDao = exports.RestaurantOrderInvoiceDao = function (_ResourceDao50) {
  _inherits(RestaurantOrderInvoiceDao, _ResourceDao50);

  function RestaurantOrderInvoiceDao(client) {
    _classCallCheck(this, RestaurantOrderInvoiceDao);

    var _this99 = _possibleConstructorReturn(this, (RestaurantOrderInvoiceDao.__proto__ || Object.getPrototypeOf(RestaurantOrderInvoiceDao)).call(this, client, 'restaurant-order-invoices'));

    _this99.relationshipDao = new RestaurantOrderInvoiceRelationshipDao(client);
    return _this99;
  }
...
var RestaurantOrderInvoiceRelationshipDao = exports.RestaurantOrderInvoiceRelationshipDao = function (_RelationshipDao50) {
  _inherits(RestaurantOrderInvoiceRelationshipDao, _RelationshipDao50);
...
var RestaurantVoteDao = exports.RestaurantVoteDao = function (_ResourceDao51) {
  _inherits(RestaurantVoteDao, _ResourceDao51);

  function RestaurantVoteDao(client) {
    _classCallCheck(this, RestaurantVoteDao);

    var _this101 = _possibleConstructorReturn(this, (RestaurantVoteDao.__proto__ || Object.getPrototypeOf(RestaurantVoteDao)).call(this, client, 'restaurant-votes'));

    _this101.relationshipDao = new RestaurantVoteRelationshipDao(client);
    return _this101;
  }
...
var RestaurantVoteRelationshipDao = exports.RestaurantVoteRelationshipDao = function (_RelationshipDao51) {
  _inherits(RestaurantVoteRelationshipDao, _RelationshipDao51);

  function RestaurantVoteRelationshipDao(client) {
    _classCallCheck(this, RestaurantVoteRelationshipDao);

    var _this102 = _possibleConstructorReturn(this, (RestaurantVoteRelationshipDao.__proto__ || Object.getPrototypeOf(RestaurantVoteRelationshipDao)).call(this, client, 'restaurant-votes'));
    ...
    _this102.get = {
      ...
      /** @method order
       ...
       @returns {Promise<Order>} **/
      order: function order(options) {
        return _this102.toOne('order', options);
      },
      ...
      /** @method restaurant
       ...
       @returns {Promise<Restaurant>} **/
      restaurant: function restaurant(options) {
        return _this102.toOne('restaurant', options);
      }
    };
...
var RoleDao = exports.RoleDao = function (_ResourceDao52) {
  _inherits(RoleDao, _ResourceDao52);

  function RoleDao(client) {
    _classCallCheck(this, RoleDao);

    var _this103 = _possibleConstructorReturn(this, (RoleDao.__proto__ || Object.getPrototypeOf(RoleDao)).call(this, client, 'roles'));

    _this103.relationshipDao = new RoleRelationshipDao(client);
    return _this103;
  }
...
var RoleRelationshipDao = exports.RoleRelationshipDao = function (_RelationshipDao52) {
  _inherits(RoleRelationshipDao, _RelationshipDao52);

  function RoleRelationshipDao(client) {
    _classCallCheck(this, RoleRelationshipDao);

    var _this104 = _possibleConstructorReturn(this, (RoleRelationshipDao.__proto__ || Object.getPrototypeOf(RoleRelationshipDao)).call(this, client, 'roles'));
    ...
    _this104.get = {
      ...
      /** @method user
       ...
       @returns {Promise<User>} **/
      user: function user(options) {
        return _this104.toOne('user', options);
      }
    };
...
var SalesforceSyncErrorDao = exports.SalesforceSyncErrorDao = function (_ResourceDao53) {
  _inherits(SalesforceSyncErrorDao, _ResourceDao53);

  function SalesforceSyncErrorDao(client) {
    _classCallCheck(this, SalesforceSyncErrorDao);

    var _this105 = _possibleConstructorReturn(this, (SalesforceSyncErrorDao.__proto__ || Object.getPrototypeOf(SalesforceSyncErrorDao)).call(this, client, 'salesforce-sync-errors'));

    _this105.relationshipDao = new SalesforceSyncErrorRelationshipDao(client);
    return _this105;
  }
...
var SalesforceSyncErrorRelationshipDao = exports.SalesforceSyncErrorRelationshipDao = function (_RelationshipDao53) {
  _inherits(SalesforceSyncErrorRelationshipDao, _RelationshipDao53);
...
var ServiceTimeDao = exports.ServiceTimeDao = function (_ResourceDao54) {
  _inherits(ServiceTimeDao, _ResourceDao54);

  function ServiceTimeDao(client) {
    _classCallCheck(this, ServiceTimeDao);

    var _this107 = _possibleConstructorReturn(this, (ServiceTimeDao.__proto__ || Object.getPrototypeOf(ServiceTimeDao)).call(this, client, 'service-times'));

    _this107.relationshipDao = new ServiceTimeRelationshipDao(client);
    return _this107;
  }
...
var ServiceTimeRelationshipDao = exports.ServiceTimeRelationshipDao = function (_RelationshipDao54) {
  _inherits(ServiceTimeRelationshipDao, _RelationshipDao54);

  function ServiceTimeRelationshipDao(client) {
    _classCallCheck(this, ServiceTimeRelationshipDao);

    var _this108 = _possibleConstructorReturn(this, (ServiceTimeRelationshipDao.__proto__ || Object.getPrototypeOf(ServiceTimeRelationshipDao)).call(this, client, 'service-times'));
    ...
    _this108.get = {
      ...
      /** @method restaurant
       ...
       @returns {Promise<Restaurant>} **/
      restaurant: function restaurant(options) {
        return _this108.toOne('restaurant', options);
      }
    };
...
var TagDao = exports.TagDao = function (_ResourceDao55) {
  _inherits(TagDao, _ResourceDao55);

  function TagDao(client) {
    _classCallCheck(this, TagDao);

    var _this109 = _possibleConstructorReturn(this, (TagDao.__proto__ || Object.getPrototypeOf(TagDao)).call(this, client, 'tags'));

    _this109.relationshipDao = new TagRelationshipDao(client);
    return _this109;
  }
...
var TagRelationshipDao = exports.TagRelationshipDao = function (_RelationshipDao55) {
  _inherits(TagRelationshipDao, _RelationshipDao55);
...
var TeamDao = exports.TeamDao = function (_ResourceDao56) {
  _inherits(TeamDao, _ResourceDao56);

  function TeamDao(client) {
    _classCallCheck(this, TeamDao);

    var _this111 = _possibleConstructorReturn(this, (TeamDao.__proto__ || Object.getPrototypeOf(TeamDao)).call(this, client, 'teams'));

    _this111.relationshipDao = new TeamRelationshipDao(client);
    return _this111;
  }
...
var TeamRelationshipDao = exports.TeamRelationshipDao = function (_RelationshipDao56) {
  _inherits(TeamRelationshipDao, _RelationshipDao56);

  function TeamRelationshipDao(client) {
    _classCallCheck(this, TeamRelationshipDao);

    var _this112 = _possibleConstructorReturn(this, (TeamRelationshipDao.__proto__ || Object.getPrototypeOf(TeamRelationshipDao)).call(this, client, 'teams'));
    ...
    _this112.index = {
      ...
      users: function users(options) {
        return _this112.toMany('users', options);
      }
    };
    return _this112;
  }
...
var UserDao = exports.UserDao = function (_ResourceDao57) {
  _inherits(UserDao, _ResourceDao57);

  function UserDao(client) {
    _classCallCheck(this, UserDao);

    var _this113 = _possibleConstructorReturn(this, (UserDao.__proto__ || Object.getPrototypeOf(UserDao)).call(this, client, 'users'));

    _this113.relationshipDao = new UserRelationshipDao(client);
    return _this113;
  }
...
var UserRelationshipDao = exports.UserRelationshipDao = function (_RelationshipDao57) {
  _inherits(UserRelationshipDao, _RelationshipDao57);

  function UserRelationshipDao(client) {
    _classCallCheck(this, UserRelationshipDao);

    var _this114 = _possibleConstructorReturn(this, (UserRelationshipDao.__proto__ || Object.getPrototypeOf(UserRelationshipDao)).call(this, client, 'users'));
    ...
    _this114.get = {
      ...
      communicationPreference: function communicationPreference(options) {
        return _this114.toOne('communication-preference', options);
      }
    };
    ...
    _this114.index = {
      ...
      driverPings: function driverPings(options) {
        return _this114.toMany('driver-pings', options);
      },
      ...
      driverWeeks: function driverWeeks(options) {
        return _this114.toMany('driver-weeks', options);
      },
      ...
      driverDays: function driverDays(options) {
        return _this114.toMany('driver-days', options);
      },
      ...
      deliveredOrders: function deliveredOrders(options) {
        return _this114.toMany('delivered-orders', options);
      },
      ...
      /** @method couriers
       ...
       @returns {Promise<IndexResult<Courier>>} **/
      couriers: function couriers(options) {
        return _this114.toMany('couriers', options);
      },
      ...
      /** @method clients
       ...
       @returns {Promise<IndexResult<Client>>} **/
      clients: function clients(options) {
        return _this114.toMany('clients', options);
      },
      ...
      roles: function roles(options) {
        return _this114.toMany('roles', options);
      },
      ...
      /** @method paymentCards
       ...
       @returns {Promise<IndexResult<PaymentCard>>} **/
      paymentCards: function paymentCards(options) {
        return _this114.toMany('payment-cards', options);
      },
      ...
      /** @method teams
       ...
       @returns {Promise<IndexResult<Team>>} **/
      teams: function teams(options) {
        return _this114.toMany('teams', options);
      },
      ...
      /** @method versions
       ...
       @returns {Promise<IndexResult<Version>>} **/
      versions: function versions(options) {
        return _this114.toMany('versions', options);
      }
    };
    return _this114;
  }
...
var UserFeedbackDao = exports.UserFeedbackDao = function (_ResourceDao58) {
  _inherits(UserFeedbackDao, _ResourceDao58);

  function UserFeedbackDao(client) {
    _classCallCheck(this, UserFeedbackDao);

    var _this115 = _possibleConstructorReturn(this, (UserFeedbackDao.__proto__ || Object.getPrototypeOf(UserFeedbackDao)).call(this, client, 'user-feedbacks'));

    _this115.relationshipDao = new UserFeedbackRelationshipDao(client);
    return _this115;
  }
...
var UserFeedbackRelationshipDao = exports.UserFeedbackRelationshipDao = function (_RelationshipDao58) {
  _inherits(UserFeedbackRelationshipDao, _RelationshipDao58);
...
var UserInviteDao = exports.UserInviteDao = function (_ResourceDao59) {
  _inherits(UserInviteDao, _ResourceDao59);

  function UserInviteDao(client) {
    _classCallCheck(this, UserInviteDao);

    var _this117 = _possibleConstructorReturn(this, (UserInviteDao.__proto__ || Object.getPrototypeOf(UserInviteDao)).call(this, client, 'user-invites'));

    _this117.relationshipDao = new UserInviteRelationshipDao(client);
    return _this117;
  }
...
var UserInviteRelationshipDao = exports.UserInviteRelationshipDao = function (_RelationshipDao59) {
  _inherits(UserInviteRelationshipDao, _RelationshipDao59);

  function UserInviteRelationshipDao(client) {
    _classCallCheck(this, UserInviteRelationshipDao);

    var _this118 = _possibleConstructorReturn(this, (UserInviteRelationshipDao.__proto__ || Object.getPrototypeOf(UserInviteRelationshipDao)).call(this, client, 'user-invites'));
    ...
    _this118.get = {
      ...
      /** @method client
       ...
       @returns {Promise<Client>} **/
      client: function client(options) {
        return _this118.toOne('client', options);
      },
      ...
      /** @method restaurant
       ...
       @returns {Promise<Restaurant>} **/
      restaurant: function restaurant(options) {
        return _this118.toOne('restaurant', options);
      },
      ...
      team: function team(options) {
        return _this118.toOne('team', options);
      },
      ...
      /** @method courier
       ...
       @returns {Promise<Courier>} **/
      courier: function courier(options) {
        return _this118.toOne('courier', options);
      },
      ...
      /** @method user
       ...
       @returns {Promise<User>} **/
      user: function user(options) {
        return _this118.toOne('user', options);
      }
    };
...
var VersionDao = exports.VersionDao = function (_ResourceDao60) {
  _inherits(VersionDao, _ResourceDao60);

  function VersionDao(client) {
    _classCallCheck(this, VersionDao);

    var _this119 = _possibleConstructorReturn(this, (VersionDao.__proto__ || Object.getPrototypeOf(VersionDao)).call(this, client, 'versions'));

    _this119.relationshipDao = new VersionRelationshipDao(client);
    return _this119;
  }
...
var VersionRelationshipDao = exports.VersionRelationshipDao = function (_RelationshipDao60) {
  _inherits(VersionRelationshipDao, _RelationshipDao60);
