...
var RestaurantClosureDao = exports.RestaurantClosureDao = function (_ResourceDao47) {
  _inherits(RestaurantClosureDao, _ResourceDao47);

  function RestaurantClosureDao(client) {
    _classCallCheck(this, RestaurantClosureDao);

    var _this93 = _possibleConstructorReturn(this, (RestaurantClosureDao.__proto__ || Object.getPrototypeOf(RestaurantClosureDao)).call(this, client, 'restaurant-closures'));

    _this93.relationshipDao = new RestaurantClosureRelationshipDao(client, 'restaurant-closures');
    return _this93;
  }
...
var RestaurantClosureRelationshipDao = exports.RestaurantClosureRelationshipDao = function (_RelationshipDao47) {
  _inherits(RestaurantClosureRelationshipDao, _RelationshipDao47);

  function RestaurantClosureRelationshipDao(client) {
    _classCallCheck(this, RestaurantClosureRelationshipDao);

    var _this94 = _possibleConstructorReturn(this, (RestaurantClosureRelationshipDao.__proto__ || Object.getPrototypeOf(RestaurantClosureRelationshipDao)).call(this, client, 'restaurant-closures'));
...
var RestaurantDiscountDao = exports.RestaurantDiscountDao = function (_ResourceDao48) {
  _inherits(RestaurantDiscountDao, _ResourceDao48);

  function RestaurantDiscountDao(client) {
    _classCallCheck(this, RestaurantDiscountDao);

    var _this95 = _possibleConstructorReturn(this, (RestaurantDiscountDao.__proto__ || Object.getPrototypeOf(RestaurantDiscountDao)).call(this, client, 'restaurant-discounts'));

    _this95.relationshipDao = new RestaurantDiscountRelationshipDao(client, 'restaurant-discounts');
    return _this95;
  }
...
var RestaurantDiscountRelationshipDao = exports.RestaurantDiscountRelationshipDao = function (_RelationshipDao48) {
  _inherits(RestaurantDiscountRelationshipDao, _RelationshipDao48);

  function RestaurantDiscountRelationshipDao(client) {
    _classCallCheck(this, RestaurantDiscountRelationshipDao);

    var _this96 = _possibleConstructorReturn(this, (RestaurantDiscountRelationshipDao.__proto__ || Object.getPrototypeOf(RestaurantDiscountRelationshipDao)).call(this, client, 'restaurant-discounts'));
    ...
    _this96.get = {
      ...
      order: function order(options) {
        return _this96.toOne('order', options);
      }
    };
...
var RestaurantOrderInvoiceDao = exports.RestaurantOrderInvoiceDao = function (_ResourceDao49) {
  _inherits(RestaurantOrderInvoiceDao, _ResourceDao49);

  function RestaurantOrderInvoiceDao(client) {
    _classCallCheck(this, RestaurantOrderInvoiceDao);

    var _this97 = _possibleConstructorReturn(this, (RestaurantOrderInvoiceDao.__proto__ || Object.getPrototypeOf(RestaurantOrderInvoiceDao)).call(this, client, 'restaurant-order-invoices'));

    _this97.relationshipDao = new RestaurantOrderInvoiceRelationshipDao(client, 'restaurant-order-invoices');
    return _this97;
  }
...
var RestaurantOrderInvoiceRelationshipDao = exports.RestaurantOrderInvoiceRelationshipDao = function (_RelationshipDao49) {
  _inherits(RestaurantOrderInvoiceRelationshipDao, _RelationshipDao49);
...
var RoleDao = exports.RoleDao = function (_ResourceDao50) {
  _inherits(RoleDao, _ResourceDao50);

  function RoleDao(client) {
    _classCallCheck(this, RoleDao);

    var _this99 = _possibleConstructorReturn(this, (RoleDao.__proto__ || Object.getPrototypeOf(RoleDao)).call(this, client, 'roles'));

    _this99.relationshipDao = new RoleRelationshipDao(client, 'roles');
    return _this99;
  }
...
var RoleRelationshipDao = exports.RoleRelationshipDao = function (_RelationshipDao50) {
  _inherits(RoleRelationshipDao, _RelationshipDao50);

  function RoleRelationshipDao(client) {
    _classCallCheck(this, RoleRelationshipDao);

    var _this100 = _possibleConstructorReturn(this, (RoleRelationshipDao.__proto__ || Object.getPrototypeOf(RoleRelationshipDao)).call(this, client, 'roles'));
    ...
    _this100.get = {
      ...
      user: function user(options) {
        return _this100.toOne('user', options);
      }
    };
...
var SalesforceSyncErrorDao = exports.SalesforceSyncErrorDao = function (_ResourceDao51) {
  _inherits(SalesforceSyncErrorDao, _ResourceDao51);

  function SalesforceSyncErrorDao(client) {
    _classCallCheck(this, SalesforceSyncErrorDao);

    var _this101 = _possibleConstructorReturn(this, (SalesforceSyncErrorDao.__proto__ || Object.getPrototypeOf(SalesforceSyncErrorDao)).call(this, client, 'salesforce-sync-errors'));

    _this101.relationshipDao = new SalesforceSyncErrorRelationshipDao(client, 'salesforce-sync-errors');
    return _this101;
  }
...
var SalesforceSyncErrorRelationshipDao = exports.SalesforceSyncErrorRelationshipDao = function (_RelationshipDao51) {
  _inherits(SalesforceSyncErrorRelationshipDao, _RelationshipDao51);
...
var ServiceTimeDao = exports.ServiceTimeDao = function (_ResourceDao52) {
  _inherits(ServiceTimeDao, _ResourceDao52);

  function ServiceTimeDao(client) {
    _classCallCheck(this, ServiceTimeDao);

    var _this103 = _possibleConstructorReturn(this, (ServiceTimeDao.__proto__ || Object.getPrototypeOf(ServiceTimeDao)).call(this, client, 'service-times'));

    _this103.relationshipDao = new ServiceTimeRelationshipDao(client, 'service-times');
    return _this103;
  }
...
var ServiceTimeRelationshipDao = exports.ServiceTimeRelationshipDao = function (_RelationshipDao52) {
  _inherits(ServiceTimeRelationshipDao, _RelationshipDao52);

  function ServiceTimeRelationshipDao(client) {
    _classCallCheck(this, ServiceTimeRelationshipDao);

    var _this104 = _possibleConstructorReturn(this, (ServiceTimeRelationshipDao.__proto__ || Object.getPrototypeOf(ServiceTimeRelationshipDao)).call(this, client, 'service-times'));
    ...
    _this104.get = {
      ...
      restaurant: function restaurant(options) {
        return _this104.toOne('restaurant', options);
      }
    };
...
var TagDao = exports.TagDao = function (_ResourceDao53) {
  _inherits(TagDao, _ResourceDao53);

  function TagDao(client) {
    _classCallCheck(this, TagDao);

    var _this105 = _possibleConstructorReturn(this, (TagDao.__proto__ || Object.getPrototypeOf(TagDao)).call(this, client, 'tags'));

    _this105.relationshipDao = new TagRelationshipDao(client, 'tags');
    return _this105;
  }
...
var TagRelationshipDao = exports.TagRelationshipDao = function (_RelationshipDao53) {
  _inherits(TagRelationshipDao, _RelationshipDao53);
...
var UserDao = exports.UserDao = function (_ResourceDao54) {
  _inherits(UserDao, _ResourceDao54);

  function UserDao(client) {
    _classCallCheck(this, UserDao);

    var _this107 = _possibleConstructorReturn(this, (UserDao.__proto__ || Object.getPrototypeOf(UserDao)).call(this, client, 'users'));

    _this107.relationshipDao = new UserRelationshipDao(client, 'users');
    return _this107;
  }
...
var UserRelationshipDao = exports.UserRelationshipDao = function (_RelationshipDao54) {
  _inherits(UserRelationshipDao, _RelationshipDao54);

  function UserRelationshipDao(client) {
    _classCallCheck(this, UserRelationshipDao);

    var _this108 = _possibleConstructorReturn(this, (UserRelationshipDao.__proto__ || Object.getPrototypeOf(UserRelationshipDao)).call(this, client, 'users'));
    ...
    _this108.get = {
      ...
      communicationPreference: function communicationPreference(options) {
        return _this108.toOne('communication-preference', options);
      }
    };
    ...
    _this108.index = {
      ...
      driverPings: function driverPings(options) {
        return _this108.toMany('driver-pings', options);
      },
      ...
      driverWeeks: function driverWeeks(options) {
        return _this108.toMany('driver-weeks', options);
      },
      ...
      driverDays: function driverDays(options) {
        return _this108.toMany('driver-days', options);
      },
      ...
      deliveredOrders: function deliveredOrders(options) {
        return _this108.toMany('delivered-orders', options);
      },
      ...
      /** @method couriers
       ...
       @returns {Promise<IndexResult<User>>} **/
      couriers: function couriers(options) {
        return _this108.toMany('couriers', options);
      },
      ...
      roles: function roles(options) {
        return _this108.toMany('roles', options);
      },
      ...
      /** @method paymentCards
       ...
       @returns {Promise<IndexResult<User>>} **/
      paymentCards: function paymentCards(options) {
        return _this108.toMany('payment-cards', options);
      },
      ...
      /** @method versions
       ...
       @returns {Promise<IndexResult<User>>} **/
      versions: function versions(options) {
        return _this108.toMany('versions', options);
      }
    };
    return _this108;
  }
...
var UserFeedbackDao = exports.UserFeedbackDao = function (_ResourceDao55) {
  _inherits(UserFeedbackDao, _ResourceDao55);

  function UserFeedbackDao(client) {
    _classCallCheck(this, UserFeedbackDao);

    var _this109 = _possibleConstructorReturn(this, (UserFeedbackDao.__proto__ || Object.getPrototypeOf(UserFeedbackDao)).call(this, client, 'user-feedbacks'));

    _this109.relationshipDao = new UserFeedbackRelationshipDao(client, 'user-feedbacks');
    return _this109;
  }
...
var UserFeedbackRelationshipDao = exports.UserFeedbackRelationshipDao = function (_RelationshipDao55) {
  _inherits(UserFeedbackRelationshipDao, _RelationshipDao55);
...
var UserInviteDao = exports.UserInviteDao = function (_ResourceDao56) {
  _inherits(UserInviteDao, _ResourceDao56);

  function UserInviteDao(client) {
    _classCallCheck(this, UserInviteDao);

    var _this111 = _possibleConstructorReturn(this, (UserInviteDao.__proto__ || Object.getPrototypeOf(UserInviteDao)).call(this, client, 'user-invites'));

    _this111.relationshipDao = new UserInviteRelationshipDao(client, 'user-invites');
    return _this111;
  }
...
var UserInviteRelationshipDao = exports.UserInviteRelationshipDao = function (_RelationshipDao56) {
  _inherits(UserInviteRelationshipDao, _RelationshipDao56);

  function UserInviteRelationshipDao(client) {
    _classCallCheck(this, UserInviteRelationshipDao);

    var _this112 = _possibleConstructorReturn(this, (UserInviteRelationshipDao.__proto__ || Object.getPrototypeOf(UserInviteRelationshipDao)).call(this, client, 'user-invites'));
    ...
    _this112.get = {
      ...
      /** @method user
       ...
       @returns {Promise<UserInvite>} **/
      user: function user(options) {
        return _this112.toOne('user', options);
      }
    };
...
var VersionDao = exports.VersionDao = function (_ResourceDao57) {
  _inherits(VersionDao, _ResourceDao57);

  function VersionDao(client) {
    _classCallCheck(this, VersionDao);

    var _this113 = _possibleConstructorReturn(this, (VersionDao.__proto__ || Object.getPrototypeOf(VersionDao)).call(this, client, 'versions'));

    _this113.relationshipDao = new VersionRelationshipDao(client, 'versions');
    return _this113;
  }
...
var VersionRelationshipDao = exports.VersionRelationshipDao = function (_RelationshipDao57) {
  _inherits(VersionRelationshipDao, _RelationshipDao57);
