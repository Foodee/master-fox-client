...
var ResourceDao = exports.ResourceDao = function () {
  ...
  _createClass(ResourceDao, [{
    ...
    value: function create(resource) {
      ...
      return this._client.post(this._route, resource.toJSONAPI(), options.include);
    }
    ...
    value: function update(resource) {
      ...
      return this._client.patch(this._route + '/' + resource.id, resource.toJSONAPI(), options.include);
    }
  }]);
